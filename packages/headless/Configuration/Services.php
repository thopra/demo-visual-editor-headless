...
use FriendsOfTYPO3\Headless\DataProcessing\VisualEditingPageInformationProcessor;
use FriendsOfTYPO3\Headless\DataProcessing\VisualEditingRecordInformationProcessor;
use FriendsOfTYPO3\Headless\DataProcessing\VisualEditingResourcesProcessor;
...
return static function (ContainerConfigurator $configurator): void {
    ...
    $services->set(VisualEditingService::class)->public();
    ...
    foreach (
        [
            ...
            VisualEditingPageInformationProcessor::class => ['identifier' => 'headless-visual-editing-page-information', 'share' => false, 'public' => true],
            VisualEditingRecordInformationProcessor::class => ['identifier' => 'headless-visual-editing-record', 'share' => false, 'public' => true],
            VisualEditingResourcesProcessor::class => ['identifier' => 'headless-visual-editing-resources', 'share' => false, 'public' => true],
