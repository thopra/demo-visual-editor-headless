...
{
    public function renderAllProperties(?\TYPO3\CMS\Core\Type\DocType $docType = null): string
    {
    ...
    public function renderProperty(string $property, ?\TYPO3\CMS\Core\Type\DocType $docType = null): string
    {
        if (GeneralUtility::makeInstance(HeadlessModeInterface::class)->withRequest($GLOBALS['TYPO3_REQUEST'])->isEnabled()) {
